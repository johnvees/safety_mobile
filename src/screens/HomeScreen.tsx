...
const plantStatus = [
  ...
  { name: 'Plant Surabaya', division: 'Feedmill', status: 'WASPADA', color: C.warn },
  { name: 'Plant Cikande', division: 'Food Processing', status: 'BAHAYA', color: C.danger },
];
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.breadcrumbRow}>
          <View style={styles.scopePill}>
            ...
            {currentUser.scope.split(' > ').map((part, i) => (
          ...
          <View style={[styles.roleBadge, { backgroundColor: 'rgba(255,255,255,0.92)' }]}>
      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('DashboardFull')}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>Status Keselamatan Plant</Text>
            <TouchableOpacity>
              <Text style={styles.seeAll}>Lihat semua</Text>
            </TouchableOpacity>
          </View>
            ...
            {plantStatus.map((p, i) => (
              <View key={p.name}>
                ...
                <View style={styles.plantRow}>
                  ...
                  <Text style={[styles.plantStatus, { color: p.color }]}>{p.status}</Text>
                </View>
              </View>
            ))}
          </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('CaseIncident')}
        activeOpacity={0.85}
      >
        <LinearGradient
...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 15, fontFamily: F.bold, color: C.white, lineHeight: 42, textAlign: 'center' },
  headerMid: { flex: 1 },
  headerGreeting: { fontSize: 12, color: 'rgba(255,255,255,0.75)', fontFamily: F.regular, lineHeight: 16 },
  headerName: { fontSize: 18, fontFamily: F.bold, color: C.white, lineHeight: 22, marginTop: -2 },
  bellBtn: {
    width: 40,
    height: 40,
    borderRadius: 12,
  ...
  bellBadgeText: { fontSize: 8, fontFamily: F.bold, color: C.white, lineHeight: 14, textAlign: 'center' },
  ...
  kpiValue: { fontSize: 28, fontFamily: F.extraBold, letterSpacing: -0.5, lineHeight: 32, color: C.ink },
  kpiLabel: { fontSize: 11.5, color: C.sec, fontFamily: F.medium, marginTop: 3 },
  ...
  feedText: { fontSize: 13, fontFamily: F.semiBold, color: C.ink, lineHeight: 18 },
  feedSub: { fontSize: 11.5, color: C.mut, marginTop: 2, fontFamily: F.regular },
